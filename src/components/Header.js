...
export default function Header() {
  return (
    <header className="flex justify-between items-center bg-orange-800
      ...
      <h1 className="text-orange-800">Ethan Ayaay</h1>
      <nav className="flex justify-evenly w-[40%] h-full">
        <a className="hover:cursor-pointer hover:bg-orange-900 hover:underline
        h-full w-full flex items-center justify-center"> About Me </a>
        <a className="hover:cursor-pointer hover:bg-orange-900
        hover:underline h-full w-full flex items-center justify-center"> Skills </a>
        <a className="hover:cursor-pointer hover:bg-orange-900
        hover:underline h-full w-full flex items-center justify-center"> Projects </a>
        <a className="hover:cursor-pointer hover:bg-orange-900
        hover:underline h-full w-full flex items-center justify-center"> Contact </a>
      </nav>
