...
export default function AboutMe() {
  return (
    <div id="about">
        <p className="text-lg text-slate-50 justify-self-center h-[100vh] bg-stone-800">A passionate software engineer who loves to create. Growing up, I've always found joy in creation whether it be through drawing, filmmaking, or songwriting.
