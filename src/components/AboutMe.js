    ...
    <div id="about" className="h-[100vh] bg-gradient-to-r from-orange-500 to-orange-700 flex flex-col justify-evenly items-center">
        <article className="flex flex-col items-center">
          ...
          <p className="text-xl text-slate-50 justify-self-center w-[85%]">I am a passionate software engineer who loves to create. Growing up, I've always found joy in creation whether it be through drawing,
            ...
            immersive, where I honed not only my technical skills in JavaScript, Node, React, Express, PostgreSQL, and MongoDB but also my non-technical communication skills through white boarding and pair-programming
            sessions. Moving forward, I'd like to keep developing my software engineering skills even further in order to create more impactful and fulfilling projects.</p>
        </article>
        <article>
